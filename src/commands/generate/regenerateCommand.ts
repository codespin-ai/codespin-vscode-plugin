...
// export function getRegenerateCommand(context: vscode.ExtensionContext) {
//   return async function regenerateCommand(
//     _: unknown,
//     args: RegeneratePageArgs
//   ): Promise<void> {
...
//     const fileDetails = (
//       await Promise.all(
//         args.includedFiles.map(async (file) => {
